...
class Mainframe ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_mgr.AddPane( self.MainPanel, wx.aui.AuiPaneInfo() .Left() .PinButton( True ).Dock().Resizable().FloatingSize( wx.DefaultSize ) )

		MainSizer = wx.WrapSizer( wx.HORIZONTAL, wx.WRAPSIZER_DEFAULT_FLAGS )

		self.MainFrameNotebook = wx.aui.AuiNotebook( self.MainPanel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.aui.AUI_NB_DEFAULT_STYLE )

		MainSizer.Add( self.MainFrameNotebook, 1, wx.EXPAND |wx.ALL, 5 )
		...
		# Connect Events
		self.Bind( wx.EVT_MENU, self.TrasformatoreExcelMenuOnMenuSelection, id = self.TrasformatoreExcelMenu.GetId() )
	...
	def TrasformatoreExcelMenuOnMenuSelection( self, event ):
		event.Skip()
...
class TrasformatoreExcelPanel ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		self.Orario Entrata = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.Orario Entrata.SetFont( wx.Font( 11, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Verdana" ) )

		bOrario.Add( self.Orario Entrata, 2, wx.ALL, 20 )
		...
		self.TabellaTutor = wx.grid.Grid( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.TabellaDocente = wx.grid.Grid( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.AggiungiDocenteButton.Bind( wx.EVT_BUTTON, self.RimuoviTutor )
